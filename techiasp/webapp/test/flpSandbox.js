		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IAS User Management",
									"targetURL": "#IASUserManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IASUserManagement-display": {
								"semanticObject": "IASUserManagement",
								"action": "display",
								"description": "IAS User Management",
								"title": "IAS User Management",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=techiasp",
									"url": sap.ui.require.toUrl("techiasp")
								}
							}
						}
					}
